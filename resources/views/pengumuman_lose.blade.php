...
<html lang="en" dir="ltr">
	<head>
		...
		<!-- TITLE -->
		<title>Lose Item - Lose and Found</title>
					...
					<div class="side-app">
						...
						<div class="main-container container-fluid">
							...
							<div class="page-header">
								<div>
									<h1 class="page-title">Pengumuman Kehilangan Barang</h1>
									<ol class="breadcrumb">
                                        <li class="breadcrumb-item" aria-current="page"><a href="{{route('home')}}">Home</a></li>
										<li class="breadcrumb-item"><a href="">Pengumuman</a></li>										
                                        <li class="breadcrumb-item active" aria-current="page">Lose</li>
									</ol>
								</div>
								<div class="ms-auto pageheader-btn">
									<a href="pengumuman_lose/create" class="btn btn-teal btn-icon text-white">
										<span>
							...
							<!-- PAGE-HEADER END -->
                            @foreach ($pengumuman_lose as $item)
                            @if($item->jenis_id==2)
												...
												<table class="table table-bordered text-wrap border-bottom w-100" id="basic-datatable">
													<thead>
														<tr>
                                                            ...
                                                            <th class="wd-15p border-bottom-0" style="width: 3rem;">Status</th>
															<th class="wd-10p border-bottom-0" style="width: 9rem;">Aksi</th>
														</tr>
													</thead>
													<tbody>
                                                   
                                                    @foreach ($pengumuman_lose as $key => $item)
                                                        @if($item->jenis_id==2)
                                                            <tr>
                                                                ...
                                                                <td class="text-center">
                                                                    <form action="{{route('pengumuman_lose.destroy',$item->id_peng)}}" method="POST">                                                                    
                                                                    @method('DELETE')
                                                                    @csrf
                                                                        ...
                                                                        <a type="button" data-bs-placement="top" href="pengumuman_lose/{{$item->id_peng}}/edit" method="GET" data-bs-toggle="tooltip" title="Edit Pengumuman" class="btn btn-icon btn-cyan mx-1 mb-1"><i class="fe fe-edit"></i></a>
