                    ...
                    <aside class="app-sidebar">
                        ...
                        <div class="main-sidemenu">
                            ...
                            <ul class="side-menu">
                                ...
                                <li class="slide">
                                    <a class="side-menu__item active" data-bs-toggle="slide" href="{{route('home')}}"><i class="side-menu__icon fe fe-home"></i><span class="side-menu__label">Dashboard</span></a>
                                </li>
                                <li class="sub-category">
                                    <h3>Pengumuman</h3>
                                </li>
                                                ...
                                                <table id="data-table" class="table table-bordered text-nowrap mb-0">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr class="border-bottom">
                                                            ...
                                                            <td class="text-center fs-15 fw-semibold"><span class="badge bg-success text-dark  me-1 mb-1 mt-1"><a class="text-white" target="_blank" href="https://wa.me/+{{$pk->nohp}}">WhatsApp</a></span></td>
