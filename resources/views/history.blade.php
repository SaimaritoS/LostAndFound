...
<!-- TITLE -->
<title>History - Lose and Found</title>
                    ...
                    <aside class="app-sidebar ">
                        ...
                        <div class="main-sidemenu">
                            ...
                            <ul class="side-menu">
                                ...
                                <li>
                                <a class="side-menu__item active" href="/history"><i class="side-menu__icon fe fe-clock"></i><span class="side-menu__label">History</span></a>
                                </li>
                            </ul>
					...
					<div class="side-app">
						...
						<div class="main-container container-fluid">
							...
							<div class="page-header">
								<div>
									<h1 class="page-title">Riwayat Pengumuman Barang</h1>
									<ol class="breadcrumb">
                            ...
                            <div class="modal fade"  id="modaldemo{{ $item->id_peng }}">
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="card-body text-start col-md-12">
                                                ...
                                                <div class="text-end mt-5">
                                                    Dihapus pada {{ \Carbon\Carbon::parse($item->deleted_at)->translatedFormat('l, d F Y')}}
                                                </div>
                                            </div>
                                        </div>
                                        </div>
                                ...
                                @foreach ($expired as $item2)
                            
                            <div class="modal fade"  id="modaldemo{{ $item2->id_peng }}">
                                <div class="modal-dialog modal-dialog-centered text-center col-md-6" role="document">
                                    <div class="modal-content modal-content-demo">
                                        <div class="modal-header">
                                            <h6 class="modal-title fw-bold fs-16">Detail Pengumuman</h6><button aria-label="Close" class="btn-close" data-bs-dismiss="modal" ><span aria-hidden="true">&times;</span></button>
                                        ...
                                        <div class="modal-body">
                                        <div class="card">
                                            <img class="card-img-top br-7 br-bl-0 br-br-0 mx-auto" style="width: 500px; height:250px;" src="{{ asset('assets/image/'.$item2->gambar)}}" alt="Image">
                                            <div class="card-body">
                                                <div class="d-md-flex justify-content-evenly">
                                                <a href="javascript:void(0);" class="d-flex me-4 mb-2"><i class="fe fe-calendar fs-16 me-1 p-3 bg-secondary-transparent text-secondary bradius"></i>
                                                    <div class="mt-0 mt-1 ms-1 text-muted font-weight-semibold">{{ \Carbon\Carbon::parse($item2->created)->translatedFormat('l, d F Y')}}
                                                        <br> <small class="d-block text-muted text-start">{{ \Carbon\Carbon::parse($item2->created)->translatedFormat('H:i:s')}}</small>
                                                    </div>
                                                </a>
                                                <a href="https://wa.me/+62{{$item2->nohp}}" target="_blank" class="d-flex me-4 mb-2"><i class="fe fe-user fs-16 me-1 p-3 bg-primary-transparent text-primary bradius"></i>
                                                    <div class="mt-0 mt-1 ms-1 text-muted font-weight-semibold text-capitalize">{{$item2->nama}}
                                                       <br> <small class="d-block text-muted text-start">0{{ $item2->nohp}}</small>
                                                    </div>
                                                </a>
                                                </div>
                                            </div>
                                            <div class="card-body text-start col-md-12">
                                                ...
                                                <tr>
                                                    <td class="col-md-5 ">Nama Barang</td>
                                                    <td class="col-md-0">:</td>
                                                    <td class="col-md-8">{{$item2->nama_item}}</td>
                                                </tr>
                                                <tr>
                                                    <td class="col-md-5 ">Merk Barang</td>
                                                    <td class="col-md-0">:</td>
                                                    <td class="col-md-8 ">{{$item2->merk}}</td>
                                                </tr>
                                                <tr>
                                                    <td class="col-md-5 ">Lokasi Ditemukan</td>
                                                    <td class="col-md-0">:</td>
                                                    <td class="col-md-8 ">{{$item2->lokasi}}</td>
                                                </tr>
                                                <tr>
                                                    <td class="col-md-5 ">Tanggal Ditemukan</td>
                                                    <td class="col-md-0">:</td>
                                                    <td class="col-md-8 text-nowrap">{{ \Carbon\Carbon::parse($item2->tanggal)->translatedFormat('l, d F Y')}} Pukul {{ \Carbon\Carbon::parse($item2->tanggal)->translatedFormat('H:i:s')}}</td>
                                                </tr>
                                                <tr>
                                                    <td class="col-md-5 ">Deskripsi Barang</td>
                                                    <td class="col-md-0">:</td>
                                                    <td class="col-md-8">{{$item2->deskripsi}}</td>
                                                </tr>
                                                </table>
                                                <div class="text-end mt-5">
                                                    Dihapus pada {{ \Carbon\Carbon::parse($item2->deleted_at)->translatedFormat('l, d F Y')}}
                                                </div>
                                            </div>
                                        </div>
                                        </div>
                                        ...
                                        <div class="col-lg-12">
                                            <div class="card">
                                                <div class="card-header">
                                                    <h3 class="card-title">Daftar Riwayat Pengumuman Barang</h3>
                                                </div>
                                                <div class="card-body">
                                                    <div class="table-responsive">
                                                        <table class="table table-bordered text-wrap border-bottom w-100" id="delete-datatable">
                                                            <thead>
                                                                <tr>
                                                                    <th class="wd-15p border-bottom-0" style="width: 1rem;">No</th>
                                                                    <th class="wd-15p border-bottom-0" style="width: 6rem;">Nama</th>
                                                                    <th class="wd-20p border-bottom-0" style="width: 6rem;">Merk</th>
                                                                    <th class="wd-20p border-bottom-0" style="width: 6rem;">Deskripsi</th>
                                                                    <th class="wd-10p border-bottom-0" style="width: 4rem;">Kategori</th>
                                                                    <th class="wd-15p border-bottom-0" style="width: 4rem;">Waktu</th>
                                                                    <th class="wd-10p border-bottom-0" style="width: 3rem;">Status</th>
                                                                    <th class="wd-15p border-bottom-0" style="width: 1rem;">Aksi</th>
                                                                </tr>
                                                            </thead>
                                                            <tbody>
                                                            @foreach ($history as $key => $item)
                                                                <tr>
                                                                    ...
                                                                    <td>Penemuan</td>
                                                                    @endif
                                                                    <td>{{ \Carbon\Carbon::parse($item->created_pengumuman)->diffForHumans() }}</td>
                                                                    <td class="text-center"><span class="badge bg-success-gradient text-dark me-1 mb-1 mt-1">{{$item->status}}</span></td>
                                                                    <td>
                                    ...
                                    <div class="row row-sm">
                                        <div class="col-lg-12">
                                            <div class="card">
                                                <div class="card-header">
                                                    <h3 class="card-title">Daftar Expired Pengumuman</h3>
                                                </div>
                                                <div class="card-body">
                                                    <div class="table-responsive">
                                                        <table class="table table-bordered text-wrap border-bottom w-100" id="basic-datatable">
                                                            ...
                                                            @foreach ($expired as $key => $item2)
                                                                <tr>
                                                                    <td>{{$loop->iteration}}</td>
                                                                    <td>{{$item2->nama_item}}</td>
                                                                    <td>{{$item2->merk}}</td>
                                                                    <td>Ditemukan di {{$item2->lokasi}}, {{$item2->deskripsi}}</td>
                                                                    @if($item2->jenis_id==2)
                                                                    <td>Kehilangan</td>
                                                                    @else
                                                                    <td>Penemuan</td>
                                                                    @endif
                                                                    <td>{{ \Carbon\Carbon::parse($item2->created_pengumuman)->diffForHumans() }}</td>
                                                                    <td class="text-center"><span class="badge bg-danger-gradient text-dark  me-1 mb-1 mt-1">{{$item2->status}}</span></td>
                                                                    <td>
                                                                        <span class="modal-effect" data-bs-effect="effect-flip-horizontal" data-bs-toggle="modal" href="#modaldemo{{ $item2->id_peng }}">
                                                                                <a data-bs-placement="top" data-bs-toggle="tooltip" title="Lihat Detail" class="btn btn-icon btn-info mx-1 mb-1" ><i class="fe fe-eye"></i></a>
                                                                        </span>  
                                                                    </td>
                                                                </tr>
