...
<html lang="en" dir="ltr">
	<head>
		...
		<!-- TITLE -->
		<title>Tambah Pengumuman Found - Lose and Found</title>
						...
						<div class="main-container container-fluid">
							...
							<div class="page-header">
								<div>
									...
									<ol class="breadcrumb">
										...
										<li class="breadcrumb-item active" aria-current="page">Form-Found</li>
									</ol>
								</div>
							...
							<div class="row">
								...
								<div class="col-lg-12 col-md-12">
                                    <form action="/pengumuman_found" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        <div class="card">
                                            ...
                                            <div class="card-body pt-2">
                                                <div class="form-group">
                                                    ...
                                                    <select name="jenis_id" id="prodi" readonly class="form-control @error('jenis_id') is-invalid @enderror"  autocomplete="off" value="1">
                                                        
                                                            <option value="1">Penemuan</option>                                     
                                                    </select>
                                                    @error('jenis_id')
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input name="nama_item" type="text" autocomplete="off" autofocus  value="{{ old('nama_item') }}" class="form-control @error('nama_item') is-invalid @enderror" placeholder="Nama Barang">
                                                    @error('nama_item')
                                                    <div class="invalid-feedback m-2">
                                                            {{$message}}
                                                    </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input name="merk" type="text" autocomplete="off"  value="{{ old('merk') }}" class="form-control @error('merk') is-invalid @enderror" placeholder="Merk Barang">
                                                    @error('merk')
                                                    <div class="invalid-feedback m-2">
                                                            {{$message}}
                                                    </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input name="lokasi" type="text" autocomplete="off"  value="{{ old('lokasi') }}" class="form-control @error('lokasi') is-invalid @enderror" placeholder="Lokasi">
                                                    @error('lokasi')
                                                    <div class="invalid-feedback m-2">
                                                            {{$message}}
                                                    </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="datetime-local"  name="tanggal" autocomplete="off" class="form-control @error('tanggal') is-invalid @enderror" value="{{ old('tanggal') }}" placeholder="">
                                                    @error('tanggal')
                                                    <div class="invalid-feedback m-2">
                                                            {{$message}}
                                                    </div>
                                                ...
                                                <div class="form-group">
													...
													<textarea name="deskripsi" style="height:150px;"  autocomplete="off" class="form-control @error('deskripsi') is-invalid @enderror" placeholder="Deskripsi.." rows="3">{{ old('deskripsi') }}</textarea>
                                                    @error('deskripsi')
                                                    <div class="invalid-feedback m-2">
                                                            {{$message}}
                                                    </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input name="gambar" autocomplete="off" type="file"  value="{{ old('gambar') }}" class="dropify @error('gambar') is-invalid @enderror" data-bs-height="180" />                                                    
                                                    @error('gambar')
                                                    <div class="invalid-feedback m-2">
                                                            {{$message}}
                                                    </div>
                                                ...
                                                <div class="form-group d-grid gap-2 col-md-2 mx-auto pt-4">
                                                    <button type="submit" class="btn btn-indigo ">Kirim</button>
                                                </div>
                                            </div>
                                        </div>
                                    </form>
