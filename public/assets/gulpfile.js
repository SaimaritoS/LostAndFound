...
gulp.task("dark", function () {
     return gulp
          .src("zanex/assets/css/dark-style.scss")
          .pipe(sourcemaps.init())
          .pipe(sass())
          .pipe(beautify.css({ indent_size: 4 }))
          .pipe(sourcemaps.write("."))
...
gulp.task("transparent", function () {
     return gulp
          .src("zanex/assets/css/transparent-style.scss")
          .pipe(sourcemaps.init())
          .pipe(sass())
          .pipe(beautify.css({ indent_size: 4 }))
          .pipe(sourcemaps.write("."))
...
gulp.task("skins", function () {
     return gulp
          .src("zanex/assets/css/skin-modes.scss")
          .pipe(sourcemaps.init())
          .pipe(sass())
          .pipe(beautify.css({ indent_size: 4 }))
          .pipe(sourcemaps.write("."))
